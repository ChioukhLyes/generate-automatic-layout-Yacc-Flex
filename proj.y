...
Position = HPDF_Page_GetCurrentTextPos(page[HPDF_mypage]);
	...
	if(HPDF_Temp[0] != 0){
	HPDF_Page_TextRect (page[HPDF_mypage],  misenpage.left, Position.y - 20, misenpage.right, misenpage.top,
...
HPDF_Page_TextRect (page[HPDF_mypage],  misenpage.left, Position.y - 32, misenpage.right, misenpage.top,HPDF_Temp, HPDF_TALIGN_LEFT, NULL);
}
